  ...
  return (
    <div className="flex flex-col justify-center items-center pt-6 pb-40 bg-[#9538E2] lg:w-[98%] mx-auto rounded-b-xl text-white relative mb-80">
      <div className="flex flex-col justify-center items-center lg:w-[60%] text-center">
        ...
        <button className='mt-6 mb-24 px-6 py-3 rounded-3xl bg-white text-[#9538E2] font-bold cursor-pointer'>Shop Now</button>
      </div>
      <div className='w-[50%] rounded-xl p-1 border bg-transparent backdrop-filter lg:absolute translate-y-3/4'>
